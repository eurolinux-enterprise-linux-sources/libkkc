/* template.c generated by valac 0.20.1.19-a6516, the Vala compiler
...
static void template_tests_test_properties (TemplateTests* self) {
	...
	KkcSimpleTemplate* _tmp0_;
	KkcTemplate* _tmp1_;
	const gchar* _tmp2_;
	gboolean _tmp3_;
	KkcOkuriganaTemplate* _tmp4_;
	KkcTemplate* _tmp5_;
	const gchar* _tmp6_;
	gboolean _tmp7_;
	KkcNumericTemplate* _tmp8_;
	KkcTemplate* _tmp9_;
	const gchar* _tmp10_;
	gboolean _tmp11_;
	KkcTemplate* _tmp12_;
...
gint _vala_main (gchar** args, int args_length1) {
	...
	TemplateTests* _tmp1_;
	TemplateTests* _tmp2_;
