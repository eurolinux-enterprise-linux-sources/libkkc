/* encoding.c generated by valac 0.20.1.19-a6516, the Vala compiler
...
gint _vala_main (gchar** args, int args_length1) {
	...
	EncodingConverterTests* _tmp1_;
	EncodingConverterTests* _tmp2_;
