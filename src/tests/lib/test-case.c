/* test-case.c generated by valac 0.20.1.19-a6516, the Vala compiler
...
void kkc_test_case_add_test (KkcTestCase* self, const gchar* name, KkcTestCaseTestMethod test, void* test_target) {
	...
	const gchar* _tmp0_;
	KkcTestCaseTestMethod _tmp1_;
	void* _tmp1__target;
	KkcTestCaseAdaptor* _tmp2_;
	KkcTestCaseAdaptor** _tmp3_;
	gint _tmp3__length1;
	KkcTestCaseAdaptor* _tmp4_;
	GTestSuite* _tmp5_;
	const gchar* _tmp6_;
	const gchar* _tmp7_;
	GTestCase* _tmp8_;
