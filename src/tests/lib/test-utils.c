/* test-utils.c generated by valac 0.20.1.19-a6516, the Vala compiler
...
void kkc_test_utils_check_conversion_result (KkcContext* context, JsonObject* expected) {
	...
	gchar* _tmp53_;
	KkcContext* _tmp54_;
	KkcCandidateList* _tmp55_;
	KkcCandidateList* _tmp56_;
	gint _tmp57_;
	gint _tmp58_;
	JsonObject* _tmp59_;
...
#line 39 "/home/ueno/devel/libkkc/tests/lib/test-utils.vala"
	if (_tmp41_) {
#line 349 "test-utils.c"
		gint64 expected_segments_cursor_pos = 0LL;
		JsonObject* _tmp42_;
		gint64 _tmp43_ = 0LL;
		KkcContext* _tmp44_;
		KkcSegmentList* _tmp45_;
...
#line 45 "/home/ueno/devel/libkkc/tests/lib/test-utils.vala"
	if (_tmp60_) {
#line 409 "test-utils.c"
		gint64 expected_candidates_size = 0LL;
		JsonObject* _tmp61_;
		gint64 _tmp62_ = 0LL;
		KkcContext* _tmp63_;
		KkcCandidateList* _tmp64_;
		KkcCandidateList* _tmp65_;
		gint _tmp66_;
		gint _tmp67_;
		gint64 _tmp68_;
...
#line 66 "/home/ueno/devel/libkkc/tests/lib/test-utils.vala"
	_tmp10_ = __vala_JsonArray_copy0 (_tmp9_);
#line 66 "/home/ueno/devel/libkkc/tests/lib/test-utils.vala"
	array = _tmp10_;
#line 630 "test-utils.c"
	{
		gint i = 0;
#line 68 "/home/ueno/devel/libkkc/tests/lib/test-utils.vala"
		i = 0;
#line 635 "test-utils.c"
		{
