...
#line 186 "language-model.c"
	{
		...
		gchar* _tmp8_ = NULL;
		gchar* _tmp9_;
		KkcLanguageModelMetadata* _tmp10_;
		KkcLanguageModelMetadata* _tmp11_;
...
#line 239 "language-model.c"
	}
	{
		...
		gchar* _tmp13_ = NULL;
		gchar* _tmp14_;
		KkcLanguageModelMetadata* _tmp15_;
		KkcLanguageModelMetadata* _tmp16_;
...
gint _vala_main (gchar** args, int args_length1) {
	...
	LanguageModelTests* _tmp1_;
	LanguageModelTests* _tmp2_;
