/* sorted-trigram-language-model.c generated by valac 0.20.1.19-a6516, the Vala compiler
...
static gboolean kkc_sorted_trigram_language_model_real_parse (KkcLanguageModel* base, GError** error) {
	...
	if (_tmp8_) {
		...
		gchar* _tmp11_;
		gchar* _tmp12_;
		KkcMappedIndexFile* _tmp13_;
		KkcMappedIndexFile* _tmp14_;
		_tmp10_ = prefix;
		...
		gchar* _tmp17_;
		gchar* _tmp18_;
		KkcLoadedIndexFile* _tmp19_;
		KkcLoadedIndexFile* _tmp20_;
		_tmp16_ = prefix;
