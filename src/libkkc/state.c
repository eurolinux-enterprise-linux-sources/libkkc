/* state.c generated by valac 0.20.1.19-a6516, the Vala compiler
...
gchar* kkc_state_get_input (KkcState* self) {
	...
	g_string_append (_tmp22_, _tmp25_);
	{
		...
		while (TRUE) {
			...
			gint _tmp32_;
			GString* _tmp33_;
			KkcRomKanaCharacterList* _tmp34_;
			gint _tmp35_;
			KkcRomKanaCharacter _tmp36_ = {0};
			KkcRomKanaCharacter _tmp37_;
			const gchar* _tmp38_;
			_tmp27_ = _tmp26_;
			if (!_tmp27_) {
				gint _tmp28_;
...
KkcState* kkc_state_construct (GType object_type, KkcLanguageModel* model, KkcDictionaryList* dictionaries) {
	...
	__catch10_g_error:
	{
		...
		_inner_error_ = NULL;
		_tmp15_ = e->message;
		g_warning ("state.vala:201: cannot load default rule: %s", _tmp15_);
...
static gchar* kkc_state_lookup_single_for_dictionary (KkcState* self, KkcDictionary* dictionary, const gchar* input) {
	...
	const gchar* _tmp20_;
	KkcOkuriganaTemplate* _tmp21_;
	KkcSegmentDictionary* _tmp22_;
	KkcTemplate* _tmp23_;
	const gchar* _tmp24_;
	const gchar* _tmp25_;
	KkcTemplate* _tmp26_;
...
void kkc_state_lookup (KkcState* self, KkcSegment* segment) {
	...
	const gchar* _tmp18_;
	KkcOkuriganaTemplate* _tmp19_;
	KkcOkuriganaTemplate* _tmp20_;
	const gchar* _tmp21_;
	gint _tmp22_ = 0;
	const gchar* _tmp42_;
	KkcNumericTemplate* _tmp43_;
	KkcNumericTemplate* _tmp44_;
	const gchar* _tmp45_;
	KkcSimpleTemplate* _tmp46_;
	KkcSimpleTemplate* _tmp47_;
	const gchar* _tmp48_;
	KkcOkuriganaTemplate* _tmp49_;
	KkcOkuriganaTemplate* _tmp50_;
	KkcCandidateList* kana_candidates = NULL;
	KkcCandidateList* _tmp51_;
	...
	KkcCandidateList* _tmp107_;
	KkcCandidateList* _tmp108_;
	g_return_if_fail (self != NULL);
		...
		entries = _tmp25_;
		{
			...
			while (TRUE) {
				...
				if (_tmp35_ > KKC_MIN_UNIGRAM_COST) {
					...
					const gchar* _tmp38_;
					KkcCandidate* _tmp39_;
					KkcCandidateList* _tmp40_;
					KkcCandidate* _tmp41_;
			...
			while (TRUE) {
				...
				if (_tmp65_ != NULL) {
					...
					if (g_strcmp0 (_tmp70_, _tmp73_) != 0) {
						...
						const gchar* _tmp74_;
						const gchar* _tmp75_;
						KkcCandidate* _tmp76_;
						KkcCandidateList* _tmp77_;
	...
	_tmp86__length1 = _segments_length1;
	{
		...
		for (_segment_it = 0; _segment_it < _tmp86__length1; _segment_it = _segment_it + 1) {
			...
			_segment = _tmp87_;
			{
				...
				GString* _tmp98_;
				const gchar* _tmp99_;
				KkcCandidate* _tmp100_;
				KkcCandidateList* _tmp101_;
				...
				if (!_tmp103_) {
					KkcCandidateList* _tmp104_;
					KkcCandidate* _tmp105_;
...
static void kkc_state_apply_phrase_for_dictionary (KkcState* self, KkcDictionary* dictionary) {
	...
	offset = 0;
	{
		...
		while (TRUE) {
			...
			KkcPrefixEntry* _tmp40_;
			gint _tmp41_;
			gint _tmp42_;
			gchar** _value = NULL;
			gint _value_length1 = 0;
			gint __value_size_ = 0;
			KkcSentenceDictionary* _tmp43_;
			KkcPrefixEntry* _tmp44_;
			gchar** _tmp45_;
...
gint kkc_state_get_input_cursor_pos (KkcState* self) {
	...
	if (_tmp0_ >= 0) {
		...
		_tmp3_ = kkc_rom_kana_converter_get_pending_output (_tmp2_);
		_tmp4_ = _tmp3_;
		_tmp5_ = g_utf8_strlen (_tmp4_, (gssize) (-1));
		result = _tmp1_ + _tmp5_;
		return result;
	}
	_tmp6_ = self->input_characters_cursor_pos;
	result = _tmp6_;
