/* nicola.c generated by valac 0.20.1.19-a6516, the Vala compiler
...
static KkcKeyEvent* kkc_nicola_key_event_filter_queue (KkcNicolaKeyEventFilter* self, KkcKeyEvent* key, gint64 time, gint64* wait) {
	...
	KkcKeyEvent* _tmp68_;
	gint64 _tmp69_;
	KkcNicolaKeyEventFilterTimedEntry* _tmp70_;
	KkcNicolaKeyEventFilterTimedEntry* _tmp71_;
	gint64 _tmp72_;
	...
	if (_tmp8_) {
		...
		KkcNicolaKeyEventFilterTimedEntry* _tmp11_;
	...
	if (_tmp18_) {
		...
		KkcNicolaKeyEventFilterTimedEntry* _tmp25_;
	...
	if (_tmp31_ > 0) {
		...
		KkcNicolaKeyEventFilterTimedEntry* _tmp34_;
	...
	if (_tmp41_) {
		...
		KkcNicolaKeyEventFilterTimedEntry* _tmp44_;
		gint64 _tmp45_;
		KkcKeyEvent* _tmp46_;
		gint64 _tmp47_;
		gint64 _tmp48_ = 0LL;
...
static gint64 kkc_nicola_key_event_filter_get_next_wait (KkcNicolaKeyEventFilter* self, KkcKeyEvent* key, gint64 time) {
	...
	if (_tmp2_ > 0) {
		...
		gee_bidir_iterator_last ((GeeBidirIterator*) _tmp5_);
		{
			...
			while (TRUE) {
				...
				gint64 _tmp12_;
				KkcNicolaKeyEventFilterTimedEntry* _tmp13_;
				gint64 _tmp14_;
				gint64 _tmp15_;
				_tmp7_ = _tmp6_;
				if (!_tmp7_) {
	...
	if (_tmp19_ > 0) {
		...
		KkcNicolaKeyEventFilterTimedEntry* _tmp24_;
		gint64 _tmp25_;
		gint64 _tmp26_;
...
static KkcKeyEvent* kkc_nicola_key_event_filter_dispatch_single (KkcNicolaKeyEventFilter* self, gint64 time) {
	...
	gint64 _tmp2_;
	KkcNicolaKeyEventFilterTimedEntry* _tmp3_;
	gint64 _tmp4_;
	gint64 _tmp5_;
	g_return_val_if_fail (self != NULL, NULL);
	_tmp0_ = self->priv->pending;
	...
	if ((_tmp2_ - _tmp4_) > _tmp5_) {
		...
		KkcNicolaKeyEventFilterTimedEntry* _tmp7_;
...
static KkcKeyEvent* kkc_nicola_key_event_filter_dispatch (KkcNicolaKeyEventFilter* self, gint64 time) {
	...
	if (_tmp2_ == 3) {
		...
		gint64 t1 = 0LL;
		KkcNicolaKeyEventFilterTimedEntry* _tmp9_;
		gint64 _tmp10_;
		KkcNicolaKeyEventFilterTimedEntry* _tmp11_;
		gint64 _tmp12_;
		gint64 t2 = 0LL;
		KkcNicolaKeyEventFilterTimedEntry* _tmp13_;
		gint64 _tmp14_;
		KkcNicolaKeyEventFilterTimedEntry* _tmp15_;
		gint64 _tmp16_;
		gint64 _tmp17_;
		gint64 _tmp18_;
		_tmp3_ = self->priv->pending;
		...
		if (_tmp17_ <= _tmp18_) {
			...
			KkcNicolaKeyEventFilterTimedEntry* _tmp21_;
			KkcKeyEvent* r = NULL;
			gint64 _tmp22_;
			KkcKeyEvent* _tmp23_ = NULL;
			KkcNicolaKeyEventFilterTimedEntry* _tmp24_;
			gconstpointer _tmp25_;
			KkcNicolaKeyEventFilterTimedEntry* _tmp26_;
			gconstpointer _tmp27_;
			KkcKeyEvent* output = NULL;
			KkcNicolaKeyEventFilterTimedEntry* _tmp28_;
			...
			GeeLinkedList* _tmp32_;
			KkcNicolaKeyEventFilterTimedEntry* _tmp33_;
			gconstpointer _tmp34_;
			KkcNicolaKeyEventFilterTimedEntry* _tmp35_;
			gconstpointer _tmp36_;
			KkcKeyEvent* output = NULL;
			KkcNicolaKeyEventFilterTimedEntry* _tmp37_;
			gconstpointer _tmp38_;
			KkcKeyEvent* _tmp39_ = NULL;
			KkcKeyEvent* _tmp40_;
			KkcNicolaKeyEventFilterTimedEntry* _tmp41_;
		...
		if (_tmp46_ == 2) {
			...
			KkcNicolaKeyEventFilterTimedEntry* _tmp51_;
			gint64 _tmp52_;
			KkcNicolaKeyEventFilterTimedEntry* _tmp53_;
			gint64 _tmp54_;
			gint64 _tmp55_;
			...
			if ((_tmp52_ - _tmp54_) > _tmp55_) {
				...
				KkcNicolaKeyEventFilterTimedEntry* _tmp58_;
				KkcKeyEvent* r = NULL;
				gint64 _tmp59_;
				KkcKeyEvent* _tmp60_ = NULL;
				KkcKeyEvent* output = NULL;
				KkcNicolaKeyEventFilterTimedEntry* _tmp61_;
				...
				KkcNicolaKeyEventFilterTimedEntry* _tmp67_;
				...
				if (_tmp73_) {
					...
					KkcNicolaKeyEventFilterTimedEntry* _tmp75_;
					...
					if (_tmp77_) {
						KkcNicolaKeyEventFilterTimedEntry* _tmp78_;
				...
				if (_tmp82_) {
					...
					KkcNicolaKeyEventFilterTimedEntry* _tmp85_;
					KkcKeyEvent* r = NULL;
					gint64 _tmp86_;
					KkcKeyEvent* _tmp87_ = NULL;
					KkcKeyEvent* output = NULL;
					KkcNicolaKeyEventFilterTimedEntry* _tmp88_;
					...
					gint64 _tmp92_;
					KkcNicolaKeyEventFilterTimedEntry* _tmp93_;
					gint64 _tmp94_;
					gint64 _tmp95_;
					_tmp92_ = time;
					_tmp93_ = a;
					...
					if ((_tmp92_ - _tmp94_) > _tmp95_) {
						...
						KkcNicolaKeyEventFilterTimedEntry* _tmp97_;
						...
						if (_tmp99_) {
							KkcNicolaKeyEventFilterTimedEntry* _tmp100_;
							gconstpointer _tmp101_;
							KkcNicolaKeyEventFilterTimedEntry* _tmp102_;
							gconstpointer _tmp103_;
							KkcNicolaKeyEventFilterTimedEntry* _tmp104_;
							gconstpointer _tmp105_;
							KkcKeyEvent* _tmp106_;
							_tmp100_ = b;
							...
							KkcNicolaKeyEventFilterTimedEntry* _tmp107_;
							gconstpointer _tmp108_;
							KkcNicolaKeyEventFilterTimedEntry* _tmp109_;
							gconstpointer _tmp110_;
							KkcNicolaKeyEventFilterTimedEntry* _tmp111_;
							gconstpointer _tmp112_;
							KkcKeyEvent* _tmp113_;
							_tmp107_ = a;
...
static KkcKeyEvent* kkc_nicola_key_event_filter_decompose_shifted (KkcNicolaKeyEventFilter* self, KkcKeyEvent* key) {
	KkcKeyEvent* result = NULL;
	KkcKeyEvent* _tmp0_;
	KkcModifierType _tmp1_;
	KkcModifierType _tmp2_;
	KkcKeyEvent* _tmp11_;
	KkcModifierType _tmp12_;
	KkcModifierType _tmp13_;
	KkcKeyEvent* _tmp22_;
	KkcKeyEvent* _tmp23_;
	g_return_val_if_fail (self != NULL, NULL);
	g_return_val_if_fail (key != NULL, NULL);
	...
	if ((_tmp13_ & KKC_MODIFIER_TYPE_RSHIFT_MASK) != 0) {
		...
		KkcKeyEvent* _tmp16_;
		KkcKeyEvent* _tmp17_;
		KkcModifierType _tmp18_;
		KkcModifierType _tmp19_;
		KkcKeyEvent* _tmp20_;
		KkcKeyEvent* _tmp21_;
