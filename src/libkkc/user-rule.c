/* user-rule.c generated by valac 0.20.1.19-a6516, the Vala compiler
	...
	if (_tmp14_ != NULL) {
		...
		_tmp22__length1 = entries_length1;
		{
			...
			for (entry_it = 0; entry_it < _tmp22__length1; entry_it = entry_it + 1) {
				...
				{
					JsonBuilder* _tmp24_;
					KkcKeymapEntry _tmp25_;
					KkcKeyEvent* _tmp26_;
					gchar* _tmp27_ = NULL;
					gchar* _tmp28_;
					KkcKeymapEntry _tmp29_;
					const gchar* _tmp30_;
					_tmp24_ = builder;
					_tmp25_ = entry;
					_tmp26_ = _tmp25_.key;
