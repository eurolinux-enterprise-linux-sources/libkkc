/* map-file.c generated by valac 0.20.1.19-a6516, the Vala compiler
...
static void kkc_map_file_load (KkcMapFile* self, KkcRuleMetadata* metadata, const gchar* type, const gchar* name, GeeSet* parents, GeeMap* maps, GeeMap* parent_maps, GError** error) {
	...
	if (_tmp28_) {
		...
		_tmp37_ = __vala_JsonArray_copy0 (_tmp36_);
		include = _tmp37_;
		_tmp38_ = include;
		...
		_tmp40_ = elements;
		{
			...
			for (element_it = element_collection; element_it != NULL; element_it = element_it->next) {
				...
				element = (JsonNode*) element_it->data;
				{
					...
					KkcRuleMetadata* _tmp69_;
					GeeSet* _tmp72_;
					const gchar* _tmp73_;
					KkcRuleMetadata* _tmp74_;
					const gchar* _tmp75_;
					const gchar* _tmp76_;
					GeeSet* _tmp77_;
					GeeMap* _tmp78_;
	...
	if (_tmp81_) {
		...
		_tmp90_ = __vala_JsonObject_copy0 (_tmp89_);
		define = _tmp90_;
		_tmp91_ = define;
