/* rule.c generated by valac 0.20.1.19-a6516, the Vala compiler
	...
	g_return_if_fail (map != NULL);
	{
		...
		while (TRUE) {
			...
			if (_tmp14_ == JSON_NODE_ARRAY) {
				...
				_tmp17_ = __vala_JsonArray_copy0 (_tmp16_);
				components = _tmp17_;
				_tmp18_ = components;
				...
				if (_tmp23_) {
					...
					KkcRomKanaNode* _tmp64_;
					const gchar* _tmp65_;
					KkcRomKanaEntry _tmp66_;
					_tmp24_ = components;
				...
				if (_tmp16_) {
					{
						...
						const gchar* _tmp17_;
						const gchar* _tmp18_;
						KkcRuleMetadata* _tmp19_;
						GeeMap* _tmp20_;
						const gchar* _tmp21_;
						KkcRuleMetadata* _tmp22_;
						_tmp17_ = name;
...
KkcKeymap* kkc_rule_get_keymap (KkcRule* self, KkcInputMode mode) {
	...
	KkcKeymapMapFile** _tmp0_;
	gint _tmp0__length1;
	KkcInputMode _tmp1_;
	KkcKeymapMapFile* _tmp2_;
	KkcKeymap* _tmp3_;
	KkcKeymap* _tmp4_;
	g_return_val_if_fail (self != NULL, NULL);
...
static gboolean kkc_rule_real_init (GInitable* base, GCancellable* cancellable, GError** error) {
	...
	KkcRuleMetadata* _tmp37_;
	KkcRuleMetadata* _tmp38_;
	KkcRuleMetadata* _tmp39_;
	gchar* _tmp40_ = NULL;
	gchar* _tmp41_;
	gboolean _tmp42_;
	KkcRomKanaMapFile* _tmp45_ = NULL;
	KkcRuleMetadata* _tmp46_;
	KkcRomKanaMapFile* _tmp47_;
	KkcRuleMetadata* _tmp48_;
	KkcKeyEventFilter* _tmp49_ = NULL;
	KkcKeyEventFilter* _tmp50_;
	GError * _inner_error_ = NULL;
	self = (KkcRule*) base;
	...
	self->priv->_keymaps_size_ = self->priv->keymaps_length1;
	{
		...
		i = _tmp6_;
		{
			...
			while (TRUE) {
				...
				if (_tmp17_ != NULL) {
					KkcRuleMetadata* _metadata = NULL;
					KkcRuleMetadata* _tmp18_;
					KkcRuleMetadata* _tmp19_;
					KkcRuleMetadata* _tmp20_;
					GEnumValue* _tmp21_;
					const gchar* _tmp22_;
					gchar* _tmp23_ = NULL;
					gchar* _tmp24_;
					...
					KkcRuleMetadata* _tmp29_;
					GEnumValue* _tmp30_;
					const gchar* _tmp31_;
					KkcKeymapMapFile* _tmp32_;
					KkcKeymapMapFile** _tmp33_;
					gint _tmp33__length1;
					GEnumValue* _tmp34_;
					gint _tmp35_;
					KkcKeymapMapFile* _tmp36_;
					...
					_g_free0 (_tmp24_);
					if (_tmp25_) {
						KkcRuleMetadata* _tmp26_;
						KkcRuleMetadata* _tmp27_;
	...
	_g_free0 (_tmp41_);
	if (_tmp42_) {
		KkcRuleMetadata* _tmp43_;
		KkcRuleMetadata* _tmp44_;
					...
					if (_tmp20_) {
						{
							...
							const gchar* _tmp21_;
							const gchar* _tmp22_;
							KkcRuleMetadata* _tmp23_;
							GeeSet* _tmp24_;
							const gchar* _tmp25_;
							KkcRuleMetadata* _tmp26_;
							const gchar* _tmp27_;
							KkcRuleMetadata** _tmp28_;
							gint _tmp28__length1;
							KkcRuleMetadata* _tmp29_;
							KkcRuleMetadata* _tmp30_;
							_tmp21_ = name;
