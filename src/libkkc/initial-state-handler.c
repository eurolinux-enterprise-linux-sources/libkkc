/* initial-state-handler.c generated by valac 0.20.1.19-a6516, the Vala compiler
...
static gboolean kkc_initial_state_handler_do_delete (KkcInitialStateHandler* self, const gchar* command, KkcState* state, KkcKeyEvent* key) {
	...
	gint _tmp7_;
	KkcState* _tmp16_;
	KkcRomKanaCharacterList* _tmp17_;
	gint _tmp18_;
	gint _tmp19_;
	g_return_val_if_fail (self != NULL, FALSE);
	g_return_val_if_fail (state != NULL, FALSE);
	...
	if (_tmp7_ >= 0) {
		...
		if (_tmp9_ > 0) {
			KkcState* _tmp10_;
			KkcRomKanaCharacterList* _tmp11_;
			KkcState* _tmp12_;
			KkcState* _tmp13_;
			gint _tmp14_;
			gint _tmp15_;
	...
	if (_tmp19_ > 0) {
		KkcState* _tmp20_;
		KkcRomKanaCharacterList* _tmp21_;
		KkcState* _tmp22_;
		KkcRomKanaCharacterList* _tmp23_;
		gint _tmp24_;
		gint _tmp25_;
		_tmp20_ = state;
...
static gboolean kkc_initial_state_handler_do_next_candidate (KkcInitialStateHandler* self, const gchar* command, KkcState* state, KkcKeyEvent* key) {
	...
	if (_tmp7_ > ((gssize) 0)) {
		...
		KkcSegment* _tmp19_;
		KkcState* _tmp20_;
		KkcSegmentList* _tmp21_;
		KkcState* _tmp22_;
		KkcState* _tmp23_;
		KkcSegmentList* _tmp24_;
		KkcState* _tmp25_;
		KkcSegmentList* _tmp26_;
		gint _tmp27_;
		gint _tmp28_;
...
static gboolean kkc_initial_state_handler_do_next_character (KkcInitialStateHandler* self, const gchar* command, KkcState* state, KkcKeyEvent* key) {
	...
	if (_tmp6_ == (_tmp10_ - 1)) {
		...
		if (_tmp14_ >= 0) {
			...
			gint _tmp16_;
			KkcState* _tmp17_;
			KkcRomKanaCharacterList* _tmp18_;
			gint _tmp19_;
			gint _tmp20_;
			_tmp15_ = state;
...
static gboolean kkc_initial_state_handler_do_ (KkcInitialStateHandler* self, const gchar* command, KkcState* state, KkcKeyEvent* key) {
	...
	if (_tmp16_) {
		...
		if (_tmp22_) {
			KkcState* _tmp23_;
			KkcRomKanaConverter* _tmp24_;
			KkcKeyEvent* _tmp25_;
			gunichar _tmp26_;
			gunichar _tmp27_;
			KkcState* _tmp28_;
			KkcRomKanaConverter* _tmp29_;
			KkcRomKanaCharacterList* _tmp30_;
			...
			if (_tmp33_ > 0) {
				...
				gint _tmp35_;
				KkcState* _tmp70_;
				KkcRomKanaConverter* _tmp71_;
				KkcRomKanaCharacterList* _tmp72_;
				KkcRomKanaCharacterList* _tmp73_;
				_tmp34_ = state;
				_tmp35_ = _tmp34_->input_characters_cursor_pos;
				if (_tmp35_ >= 0) {
					KkcState* _tmp36_;
					KkcRomKanaCharacterList* _tmp37_;
					KkcState* _tmp38_;
					gint _tmp39_;
					KkcState* _tmp40_;
					KkcRomKanaConverter* _tmp41_;
					KkcRomKanaCharacterList* _tmp42_;
					KkcRomKanaCharacterList* _tmp43_;
					_tmp36_ = state;
					...
					kkc_rom_kana_character_list_insert_all (_tmp37_, _tmp39_, _tmp43_);
					{
						...
						KkcState* _tmp44_;
						KkcRomKanaConverter* _tmp45_;
						KkcRomKanaCharacterList* _tmp46_;
						KkcRomKanaCharacterList* _tmp47_;
						KkcRomKanaCharacterList* _tmp48_;
						gint _c_size = 0;
						KkcRomKanaCharacterList* _tmp49_;
						gint _tmp50_;
						gint _tmp51_;
						gint _c_index = 0;
						_tmp44_ = state;
						...
						while (TRUE) {
							...
							KkcRomKanaCharacterList* _tmp55_;
							gint _tmp56_;
							KkcRomKanaCharacter _tmp57_ = {0};
							KkcState* _tmp58_;
							KkcState* _tmp59_;
							gint _tmp60_;
							KkcRomKanaCharacter _tmp61_;
							const gchar* _tmp62_;
							gint _tmp63_ = 0;
							_tmp52_ = _c_index;
							_c_index = _tmp52_ + 1;
					...
					KkcState* _tmp64_;
					KkcRomKanaCharacterList* _tmp65_;
					KkcState* _tmp66_;
					KkcRomKanaConverter* _tmp67_;
					KkcRomKanaCharacterList* _tmp68_;
					KkcRomKanaCharacterList* _tmp69_;
					_tmp64_ = state;
			...
			if (_tmp81_) {
				...
				gchar* _tmp87_;
				KkcState* _tmp88_;
				KkcInputMode _tmp89_;
				KkcInputMode _tmp90_;
				gchar* _tmp91_ = NULL;
				KkcKeyEvent* _tmp92_;
				gunichar _tmp93_;
				gunichar _tmp94_;
				...
				KkcRomKanaCharacter _tmp97_;
				KkcState* _tmp98_;
				gint _tmp99_;
				KkcState* _tmp110_;
				KkcRomKanaConverter* _tmp111_;
				KkcRomKanaCharacterList* _tmp112_;
				KkcRomKanaCharacterList* _tmp113_;
				_tmp82_ = state;
				...
				if (_tmp99_ >= 0) {
					...
					KkcState* _tmp107_;
					KkcRomKanaCharacterList* _tmp108_;
					KkcRomKanaCharacter _tmp109_;
					_tmp107_ = state;
...
static gboolean kkc_initial_state_handler_real_process_key_event (KkcStateHandler* base, KkcState* state, KkcKeyEvent* key) {
	...
	gboolean _tmp39_;
	KkcState* _tmp69_;
	KkcInputMode _tmp70_;
	KkcInputMode _tmp71_;
	...
	if (_tmp4_ != NULL) {
		...
		if (_tmp12_) {
			...
			if (_tmp14_ != NULL) {
				...
				gchar* _tmp20_;
				KkcState* _tmp21_;
				KkcRomKanaCharacterList* _tmp22_;
				KkcState* _tmp23_;
	...
	if (_tmp39_) {
		...
		if (_tmp53_ != NULL) {
			...
			gint _tmp59_;
			KkcState* _tmp60_;
			KkcInputMode _tmp61_;
			KkcInputMode _tmp62_;
			_tmp54_ = state;
	...
	if (_tmp74_) {
		...
		KkcKeyEvent* _tmp76_;
		KkcModifierType _tmp77_;
		KkcModifierType _tmp78_;
		gboolean _tmp82_;
		_tmp76_ = key;
		...
		if (_tmp78_ == 0) {
			...
			KkcKeyEvent* _tmp79_;
			KkcModifierType _tmp80_;
			KkcModifierType _tmp81_;
			_tmp79_ = key;
	...
	if (_tmp83_) {
		KkcState* _tmp84_;
		KkcState* _tmp85_;
		KkcRomKanaCharacterList* _tmp86_;
		KkcKeyEvent* _tmp87_;
		gunichar _tmp88_;
		gunichar _tmp89_;
		gchar* _tmp90_ = NULL;
		...
		i = _tmp2_;
		{
			...
			while (TRUE) {
				...
				if (_tmp13_ != NULL) {
					...
					GEnumValue* _tmp18_;
					gint _tmp19_;
					KkcInitialStateHandlerConvertCommandHandler* _tmp20_;
					KkcInitialStateHandlerConvertCommandHandler* _tmp21_;
					_tmp14_ = enum_value;
