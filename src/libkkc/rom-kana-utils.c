/* rom-kana-utils.c generated by valac 0.20.1.19-a6516, the Vala compiler
...
gchar* kkc_rom_kana_utils_get_numeric (gint numeric, KkcNumericConversionType type) {
	gchar* result = NULL;
	KkcNumericConversionType _tmp0_;
	gchar* _tmp43_;
	_tmp0_ = type;
	switch (_tmp0_) {
...
static void kkc_rom_kana_utils_class_init (KkcRomKanaUtilsClass * klass) {
	...
	kkc_rom_kana_utils__WideLatinToLatinTable = (GeeMap*) _tmp4_;
	{
		...
		for (entry_it = 0; entry_it < G_N_ELEMENTS (KKC_ROM_KANA_UTILS_KanaTable); entry_it = entry_it + 1) {
			...
			{
				GeeMap* _tmp5_;
				KkcRomKanaUtilsKanaTableEntry _tmp6_;
				gunichar _tmp7_;
				KkcRomKanaUtilsKanaTableEntry _tmp8_;
				const gchar* _tmp9_;
				GeeMap* _tmp10_;
				KkcRomKanaUtilsKanaTableEntry _tmp11_;
				gunichar _tmp12_;
				KkcRomKanaUtilsKanaTableEntry _tmp13_;
				const gchar* _tmp14_;
				KkcRomKanaUtilsKanaTableEntry _tmp20_;
				const gchar* _tmp21_;
				KkcRomKanaUtilsKanaTableEntry _tmp51_;
				const gchar* _tmp52_;
				...
				gee_map_set (_tmp10_, (gpointer) ((gintptr) _tmp12_), _tmp14_);
				{
					...
					for (substitute_it = 0; substitute_it < G_N_ELEMENTS (KKC_ROM_KANA_UTILS_HankakuKatakanaSubstitute); substitute_it = substitute_it + 1) {
						...
						{
							GeeMap* _tmp15_;
							KkcRomKanaUtilsKanaTableEntry _tmp16_;
							gunichar _tmp17_;
							KkcRomKanaUtilsKanaTableEntry _tmp18_;
							const gchar* _tmp19_;
				...
				if (_tmp21_ != NULL) {
					KkcRomKanaUtilsKanaTableEntry _tmp22_;
					const gchar* _tmp23_;
					gint _tmp24_ = 0;
					_tmp22_ = entry;
					...
					if (_tmp24_ > 1) {
						...
						gunichar uc0 = 0U;
						gunichar uc1 = 0U;
						KkcRomKanaUtilsKanaTableEntry _tmp25_;
						const gchar* _tmp26_;
						gunichar _tmp27_ = 0U;
						KkcRomKanaUtilsKanaTableEntry _tmp28_;
						const gchar* _tmp29_;
						gunichar _tmp30_ = 0U;
						GeeMap* _tmp31_;
						gunichar _tmp32_;
						...
						GeeMap* _tmp41_;
						gunichar _tmp42_;
						KkcRomKanaUtilsKanaTableEntry _tmp43_;
						gunichar _tmp44_;
						index = 0;
						_tmp25_ = entry;
						...
						GeeMap* _tmp45_;
						KkcRomKanaUtilsKanaTableEntry _tmp46_;
						const gchar* _tmp47_;
						gunichar _tmp48_ = 0U;
						KkcRomKanaUtilsKanaTableEntry _tmp49_;
						gunichar _tmp50_;
				...
				if (_tmp52_ != NULL) {
					KkcRomKanaUtilsKanaTableEntry _tmp53_;
					const gchar* _tmp54_;
					gint _tmp55_ = 0;
					_tmp53_ = entry;
					...
					if (_tmp55_ > 1) {
						...
						gunichar uc0 = 0U;
						gunichar uc1 = 0U;
						KkcRomKanaUtilsKanaTableEntry _tmp56_;
						const gchar* _tmp57_;
						gunichar _tmp58_ = 0U;
						KkcRomKanaUtilsKanaTableEntry _tmp59_;
						const gchar* _tmp60_;
						gunichar _tmp61_ = 0U;
						GeeMap* _tmp62_;
						gunichar _tmp63_;
						...
						GeeMap* _tmp72_;
						gunichar _tmp73_;
						KkcRomKanaUtilsKanaTableEntry _tmp74_;
						gunichar _tmp75_;
						index = 0;
						_tmp56_ = entry;
						...
						gunichar uc = 0U;
						KkcRomKanaUtilsKanaTableEntry _tmp76_;
						const gchar* _tmp77_;
						gunichar _tmp78_ = 0U;
						GeeMap* _tmp79_;
						gunichar _tmp80_;
						...
						if (!_tmp81_) {
							GeeMap* _tmp82_;
							gunichar _tmp83_;
							KkcRomKanaUtilsKanaTableEntry _tmp84_;
							gunichar _tmp85_;
