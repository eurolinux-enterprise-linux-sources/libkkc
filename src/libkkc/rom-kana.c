/* rom-kana.c generated by valac 0.20.1.19-a6516, the Vala compiler
...
KkcRomKanaCharacterList* kkc_rom_kana_character_list_slice (KkcRomKanaCharacterList* self, gint start_char_pos, gint stop_char_pos) {
	...
	KkcRomKanaCharacterList* _tmp33_;
	...
	_result_ = _tmp33_;
	{
		...
		while (TRUE) {
			...
			gint _tmp37_;
			gint _tmp38_;
			KkcRomKanaCharacterList* _tmp39_;
			GeeList* _tmp40_;
			gint _tmp41_;
			gpointer _tmp42_ = NULL;
			KkcRomKanaCharacter* _tmp43_;
...
gboolean kkc_rom_kana_converter_flush_partial (KkcRomKanaConverter* self) {
	...
	gchar* output = NULL;
	gboolean _tmp0_ = FALSE;
	KkcRomKanaNode* _tmp1_;
	KkcRomKanaEntry* _tmp2_;
	gboolean _tmp10_;
	...
	if (_tmp10_) {
		...
		GString* _tmp19_;
		GString* _tmp20_;
		KkcRomKanaMapFile* _tmp21_;
		KkcRomKanaMapFile* _tmp22_;
		KkcRomKanaNode* _tmp23_;
		KkcRomKanaNode* _tmp24_;
	...
	if (_tmp29_) {
		...
		KkcRomKanaCharacter _tmp38_;
		GString* _tmp39_;
		GString* _tmp40_;
		KkcRomKanaMapFile* _tmp41_;
		KkcRomKanaMapFile* _tmp42_;
		KkcRomKanaNode* _tmp43_;
		KkcRomKanaNode* _tmp44_;
...
static gboolean kkc_rom_kana_converter_append_punctuation (KkcRomKanaConverter* self, gunichar uc) {
	...
	if (_tmp17_ >= 0) {
		KkcRomKanaNode* _tmp18_;
		KkcRomKanaEntry* _tmp19_;
		KkcPunctuationStyle _tmp29_;
		const gchar* _tmp30_;
		gint _tmp31_;
		gint _tmp32_ = 0;
		gunichar punctuation = 0U;
		KkcPunctuationStyle _tmp33_;
		const gchar* _tmp34_;
		gint _tmp35_;
		gunichar _tmp36_ = 0U;
		...
		if (_tmp19_ != NULL) {
			KkcRomKanaCharacterList* _tmp20_;
			GString* _tmp21_;
			const gchar* _tmp22_;
			gchar* _tmp23_;
			GString* _tmp24_;
...
gboolean kkc_rom_kana_converter_append (KkcRomKanaConverter* self, gunichar uc) {
	...
	if (_tmp20_ == NULL) {
		...
		if (_tmp23_) {
			...
			KkcRomKanaMapFile* _tmp25_;
			KkcRomKanaNode* _tmp26_;
			gunichar _tmp27_;
			KkcRomKanaNode* _tmp28_;
			...
			if (_tmp28_ == NULL) {
				...
				KkcRomKanaNode* _tmp35_;
				KkcRomKanaEntry* _tmp36_;
				...
				if (_tmp36_ != NULL) {
					...
					KkcRomKanaCharacter _tmp45_;
					GString* _tmp46_;
					GString* _tmp47_;
					KkcRomKanaMapFile* _tmp48_;
					KkcRomKanaMapFile* _tmp49_;
					KkcRomKanaNode* _tmp50_;
					KkcRomKanaNode* _tmp51_;
					gunichar _tmp52_;
					...
					if (_tmp54_) {
						...
						KkcRomKanaMapFile* _tmp58_;
						KkcRomKanaNode* _tmp59_;
						KkcRomKanaNode* _tmp60_;
						gunichar _tmp61_;
						...
						KkcRomKanaCharacterList* _tmp63_;
						GString* _tmp64_;
						const gchar* _tmp65_;
						gchar* _tmp66_;
						GString* _tmp67_;
						...
						KkcRomKanaCharacter _tmp71_;
						GString* _tmp72_;
						GString* _tmp73_;
						KkcRomKanaMapFile* _tmp74_;
						KkcRomKanaMapFile* _tmp75_;
						KkcRomKanaNode* _tmp76_;
						KkcRomKanaNode* _tmp77_;
						gunichar _tmp78_;
		...
		KkcRomKanaNode* _tmp80_;
		guint _tmp81_;
		_tmp80_ = child_node;
		_tmp81_ = _tmp80_->n_children;
		if (_tmp81_ > ((guint) 0)) {
			KkcRomKanaNode* _tmp82_;
			KkcRomKanaEntry* _tmp83_;
			KkcRomKanaNode* _tmp96_;
			KkcRomKanaNode* _tmp97_;
			_tmp82_ = child_node;
			...
			if (_tmp83_ != NULL) {
				...
				gunichar _tmp85_;
				GString* _tmp86_;
				KkcRomKanaNode* _tmp87_;
				KkcRomKanaEntry* _tmp88_;
				KkcKanaMode _tmp89_;
				gchar* _tmp90_ = NULL;
				gchar* _tmp91_;
			...
			GString* _tmp100_;
			gunichar _tmp101_;
			KkcRomKanaCharacterList* _tmp102_;
			KkcRomKanaNode* _tmp103_;
			KkcRomKanaEntry* _tmp104_;
			KkcKanaMode _tmp105_;
			gchar* _tmp106_ = NULL;
			GString* _tmp107_;
			const gchar* _tmp108_;
			gchar* _tmp109_;
			KkcRomKanaCharacter _tmp110_ = {0};
			KkcRomKanaCharacter _tmp111_;
			GString* _tmp112_;
			GString* _tmp113_;
			KkcRomKanaMapFile* _tmp114_;
			KkcRomKanaMapFile* _tmp115_;
			KkcRomKanaNode* _tmp116_;
			KkcRomKanaNode* _tmp117_;
			_tmp98_ = uc;
			...
			self->priv->current_node = _tmp117_;
			{
				...
				i = 0;
				{
					...
					while (TRUE) {
						gboolean _tmp119_;
						gint _tmp121_;
						KkcRomKanaNode* _tmp122_;
						KkcRomKanaEntry* _tmp123_;
						const gchar* _tmp124_;
						gint _tmp125_;
						gint _tmp126_;
						KkcRomKanaNode* _tmp127_;
						KkcRomKanaEntry* _tmp128_;
