/* language-model.c generated by valac 0.20.1.19-a6516, the Vala compiler
				...
				if (_tmp8_) {
					{
						...
						const gchar* _tmp10_;
						const gchar* _tmp11_;
						KkcLanguageModelMetadata* _tmp12_;
						_tmp10_ = name;
...
KkcLanguageModel* kkc_language_model_load (const gchar* name, GError** error) {
	...
	KkcLanguageModelMetadata* _tmp2_;
	KkcLanguageModel* _tmp5_ = NULL;
	KkcLanguageModelMetadata* _tmp6_;
