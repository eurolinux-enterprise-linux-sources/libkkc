/* trigram-decoder.c generated by valac 0.20.1.19-a6516, the Vala compiler
...
static gdouble kkc_unigram_to_unigram_path_cost_func_real_path_cost (KkcPathCostFunc* base, KkcTrigramLanguageModel* model, KkcTrellisNode* pnode, KkcTrellisNode* node) {
	...
	KkcLanguageModelEntry _tmp7_;
	KkcLanguageModelEntry _tmp8_;
	KkcTrigramLanguageModel* _tmp9_;
	...
	if (_kkc_language_model_entry_equal (&_tmp8_, &_tmp11_) == TRUE) {
		KkcTrigramLanguageModel* _tmp12_;
		...
		if (_tmp21_ != NULL) {
			...
			if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp23_, KKC_TYPE_UNIGRAM_TRELLIS_NODE)) {
				...
				KkcTrigramLanguageModel* _tmp36_;
				KkcUnigramTrellisNode* _tmp37_;
				KkcTrellisNode* _tmp38_;
				KkcUnigramTrellisNode* _tmp39_;
				KkcUnigramTrellisNode* _tmp40_;
				KkcLanguageModelEntry _tmp41_;
				KkcLanguageModelEntry _tmp42_;
				KkcUnigramTrellisNode* _tmp43_;
				KkcLanguageModelEntry _tmp44_;
				KkcLanguageModelEntry _tmp45_;
				KkcUnigramTrellisNode* _tmp46_;
				KkcLanguageModelEntry _tmp47_;
				KkcLanguageModelEntry _tmp48_;
				gdouble _tmp49_ = 0.0;
				_tmp36_ = model;
				_tmp37_ = upnode;
...
static gdouble kkc_unigram_to_bigram_path_cost_func_real_path_cost (KkcPathCostFunc* base, KkcTrigramLanguageModel* model, KkcTrellisNode* pnode, KkcTrellisNode* node) {
	...
	KkcLanguageModelEntry _tmp27_;
	KkcBigramTrellisNode* _tmp28_;
	KkcUnigramTrellisNode* _tmp29_;
	KkcUnigramTrellisNode* _tmp30_;
	KkcLanguageModelEntry _tmp31_;
	KkcLanguageModelEntry _tmp32_;
	KkcBigramTrellisNode* _tmp33_;
	KkcUnigramTrellisNode* _tmp34_;
	KkcUnigramTrellisNode* _tmp35_;
	KkcLanguageModelEntry _tmp36_;
	...
	if (_kkc_language_model_entry_equal (&_tmp8_, &_tmp11_) == TRUE) {
		gdouble _tmp12_;
		KkcTrigramLanguageModel* _tmp13_;
		KkcUnigramTrellisNode* _tmp14_;
		KkcLanguageModelEntry _tmp15_;
		KkcLanguageModelEntry _tmp16_;
		KkcBigramTrellisNode* _tmp17_;
		KkcUnigramTrellisNode* _tmp18_;
	...
	if (_tmp40_ != NULL) {
		...
		KkcTrellisNode* _tmp42_;
		_tmp41_ = upnode;
		_tmp42_ = ((KkcTrellisNode*) _tmp41_)->previous;
		if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp42_, KKC_TYPE_UNIGRAM_TRELLIS_NODE)) {
			gdouble _tmp43_;
			KkcTrigramLanguageModel* _tmp44_;
			KkcUnigramTrellisNode* _tmp45_;
			KkcTrellisNode* _tmp46_;
			KkcLanguageModelEntry _tmp47_;
			KkcLanguageModelEntry _tmp48_;
			KkcUnigramTrellisNode* _tmp49_;
			KkcLanguageModelEntry _tmp50_;
			KkcLanguageModelEntry _tmp51_;
			KkcBigramTrellisNode* _tmp52_;
			KkcUnigramTrellisNode* _tmp53_;
			KkcUnigramTrellisNode* _tmp54_;
			KkcLanguageModelEntry _tmp55_;
			KkcLanguageModelEntry _tmp56_;
			gdouble _tmp57_ = 0.0;
			_tmp43_ = cost;
			_tmp44_ = model;
			_tmp45_ = upnode;
			...
			gdouble _tmp58_;
			KkcTrigramLanguageModel* _tmp59_;
			KkcUnigramTrellisNode* _tmp60_;
			KkcTrellisNode* _tmp61_;
			KkcUnigramTrellisNode* _tmp62_;
			KkcUnigramTrellisNode* _tmp63_;
			KkcLanguageModelEntry _tmp64_;
			KkcLanguageModelEntry _tmp65_;
			KkcUnigramTrellisNode* _tmp66_;
			KkcLanguageModelEntry _tmp67_;
			KkcLanguageModelEntry _tmp68_;
			KkcBigramTrellisNode* _tmp69_;
			KkcUnigramTrellisNode* _tmp70_;
			KkcUnigramTrellisNode* _tmp71_;
			KkcLanguageModelEntry _tmp72_;
			KkcLanguageModelEntry _tmp73_;
			gdouble _tmp74_ = 0.0;
			_tmp58_ = cost;
			_tmp59_ = model;
			_tmp60_ = upnode;
...
static gdouble kkc_bigram_to_unigram_path_cost_func_real_path_cost (KkcPathCostFunc* base, KkcTrigramLanguageModel* model, KkcTrellisNode* pnode, KkcTrellisNode* node) {
	...
	KkcTrellisNode* _tmp2_;
	KkcBigramTrellisNode* _tmp3_;
	KkcUnigramTrellisNode* unode = NULL;
	KkcTrellisNode* _tmp4_;
	KkcUnigramTrellisNode* _tmp5_;
	gdouble cost = 0.0;
	KkcBigramTrellisNode* _tmp6_;
	KkcUnigramTrellisNode* _tmp7_;
	KkcUnigramTrellisNode* _tmp8_;
	KkcLanguageModelEntry _tmp9_;
	KkcLanguageModelEntry _tmp10_;
	KkcTrigramLanguageModel* _tmp11_;
	KkcLanguageModelEntry _tmp12_;
	KkcLanguageModelEntry _tmp13_;
	gdouble _tmp27_;
	KkcTrigramLanguageModel* _tmp28_;
	KkcBigramTrellisNode* _tmp29_;
	KkcUnigramTrellisNode* _tmp30_;
	KkcUnigramTrellisNode* _tmp31_;
	KkcLanguageModelEntry _tmp32_;
	KkcLanguageModelEntry _tmp33_;
	KkcBigramTrellisNode* _tmp34_;
	KkcUnigramTrellisNode* _tmp35_;
	KkcUnigramTrellisNode* _tmp36_;
	KkcLanguageModelEntry _tmp37_;
	...
	if (_kkc_language_model_entry_equal (&_tmp10_, &_tmp13_) == TRUE) {
		gdouble _tmp14_;
		KkcTrigramLanguageModel* _tmp15_;
		KkcBigramTrellisNode* _tmp16_;
		KkcUnigramTrellisNode* _tmp17_;
		KkcUnigramTrellisNode* _tmp18_;
		KkcLanguageModelEntry _tmp19_;
		KkcLanguageModelEntry _tmp20_;
		KkcBigramTrellisNode* _tmp21_;
		KkcUnigramTrellisNode* _tmp22_;
		KkcUnigramTrellisNode* _tmp23_;
...
static gdouble kkc_bigram_to_bigram_path_cost_func_real_path_cost (KkcPathCostFunc* base, KkcTrigramLanguageModel* model, KkcTrellisNode* pnode, KkcTrellisNode* node) {
	...
	gdouble _tmp44_ = 0.0;
	gdouble _tmp45_;
	KkcTrigramLanguageModel* _tmp46_;
	KkcBigramTrellisNode* _tmp47_;
	KkcUnigramTrellisNode* _tmp48_;
	KkcUnigramTrellisNode* _tmp49_;
	KkcLanguageModelEntry _tmp50_;
	KkcLanguageModelEntry _tmp51_;
	KkcBigramTrellisNode* _tmp52_;
	...
	KkcLanguageModelEntry _tmp55_;
	KkcLanguageModelEntry _tmp56_;
	KkcBigramTrellisNode* _tmp57_;
	KkcUnigramTrellisNode* _tmp58_;
	KkcUnigramTrellisNode* _tmp59_;
	KkcLanguageModelEntry _tmp60_;
	KkcLanguageModelEntry _tmp61_;
	gdouble _tmp62_ = 0.0;
...
static void kkc_trigram_decoder_add_trigram_nodes (KkcTrigramDecoder* self, GeeArrayList** trellis, int trellis_length1) {
	...
	gint trigram_trellis_length1;
	gint _trigram_trellis_size_;
	GeeHashSet** overlapped_nodes = NULL;
	GeeArrayList** _tmp11_;
	gint _tmp11__length1;
	GeeHashSet** _tmp12_ = NULL;
	gint overlapped_nodes_length1;
	gint _overlapped_nodes_size_;
					...
					while (TRUE) {
						...
						j = _tmp44_ - ((gint) _tmp47_);
						{
							...
							while (TRUE) {
								...
								KkcTrellisNode* _tmp61_;
								KkcUnigramTrellisNode* _tmp62_;
								KkcBigramLanguageModel* _tmp63_;
								KkcBigramLanguageModel* _tmp64_;
								KkcUnigramTrellisNode* _tmp65_;
								KkcLanguageModelEntry _tmp66_;
								KkcLanguageModelEntry _tmp67_;
								KkcUnigramTrellisNode* _tmp68_;
								KkcLanguageModelEntry _tmp69_;
								KkcLanguageModelEntry _tmp70_;
								gboolean _tmp71_ = FALSE;
								gint k = 0;
								gint _tmp72_;
								KkcTrellisNode* _tmp73_;
								guint _tmp74_;
								guint _tmp75_;
								gint _tmp76_;
								...
								}
								{
									...
									while (TRUE) {
										...
										KkcTrellisNode* _tmp90_;
										KkcUnigramTrellisNode* _tmp91_;
										gboolean _tmp92_ = FALSE;
										GeeHashSet** _tmp93_;
										gint _tmp93__length1;
										gint _tmp94_;
										GeeHashSet* _tmp95_;
										KkcUnigramTrellisNode* _tmp96_;
										...
										if (!_tmp97_) {
											KkcBigramLanguageModel* _tmp98_;
											KkcBigramLanguageModel* _tmp99_;
											KkcUnigramTrellisNode* _tmp100_;
											KkcLanguageModelEntry _tmp101_;
											KkcLanguageModelEntry _tmp102_;
											KkcUnigramTrellisNode* _tmp103_;
											KkcLanguageModelEntry _tmp104_;
											KkcLanguageModelEntry _tmp105_;
											KkcUnigramTrellisNode* _tmp106_;
											KkcLanguageModelEntry _tmp107_;
											KkcLanguageModelEntry _tmp108_;
										...
										if (_tmp110_) {
											...
											KkcUnigramTrellisNode* _tmp111_;
											KkcUnigramTrellisNode* _tmp112_;
											gint _tmp113_;
											KkcBigramTrellisNode* _tmp114_;
											GeeArrayList** _tmp115_;
											gint _tmp115__length1;
											gint _tmp116_;
											GeeArrayList* _tmp117_;
											KkcBigramTrellisNode* _tmp118_;
											GeeHashSet** _tmp119_;
											gint _tmp119__length1;
											gint _tmp120_;
											GeeHashSet* _tmp121_;
											KkcUnigramTrellisNode* _tmp122_;
											_tmp111_ = uppnode;
											_tmp112_ = upnode;
											_tmp113_ = j;
...
static gdouble kkc_trigram_decoder_real_path_cost (KkcBigramDecoder* base, KkcTrellisNode* pnode, KkcTrellisNode* node, gint endpos) {
	...
	KkcTrellisNode* _tmp1_;
	gint _tmp2_ = 0;
	KkcPathCostFunc* _tmp3_;
	KkcBigramLanguageModel* _tmp4_;
	KkcBigramLanguageModel* _tmp5_;
	KkcTrellisNode* _tmp6_;
	KkcTrellisNode* _tmp7_;
	gdouble _tmp8_ = 0.0;
	self = (KkcTrigramDecoder*) base;
	g_return_val_if_fail (pnode != NULL, 0.0);
	g_return_val_if_fail (node != NULL, 0.0);
...
KkcTrigramDecoder* kkc_trigram_decoder_construct (GType object_type, KkcTrigramLanguageModel* model) {
	...
	KkcTrigramLanguageModel* _tmp0_;
	KkcUnigramToUnigramPathCostFunc* _tmp1_;
	KkcPathCostFunc* _tmp2_;
	KkcUnigramToBigramPathCostFunc* _tmp3_;
	KkcPathCostFunc* _tmp4_;
	KkcBigramToUnigramPathCostFunc* _tmp5_;
	KkcPathCostFunc* _tmp6_;
	KkcBigramToBigramPathCostFunc* _tmp7_;
	KkcPathCostFunc* _tmp8_;
