/* convert-sentence-state-handler.c generated by valac 0.20.1.19-a6516, the Vala compiler
		...
		i = _tmp2_;
		{
			...
			while (TRUE) {
				...
				if (_tmp13_ != NULL) {
					...
					GEnumValue* _tmp18_;
					gint _tmp19_;
					KkcConvertSentenceStateHandlerConvertCommandHandler* _tmp20_;
					KkcConvertSentenceStateHandlerConvertCommandHandler* _tmp21_;
					_tmp14_ = enum_value;
