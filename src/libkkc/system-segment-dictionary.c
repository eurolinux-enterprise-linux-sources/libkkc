/* system-segment-dictionary.c generated by valac 0.20.1.19-a6516, the Vala compiler
	...
	if (_tmp11_ != NULL) {
		{
			...
			const gchar* _tmp12_;
			KkcEncodingConverter* _tmp13_;
			KkcEncodingConverter* _tmp14_;
			_tmp12_ = coding;
			...
			_tmp14_ = _converter;
			if (_tmp14_ != NULL) {
				KkcEncodingConverter* _tmp15_;
				KkcEncodingConverter* _tmp16_;
				_tmp15_ = _converter;
