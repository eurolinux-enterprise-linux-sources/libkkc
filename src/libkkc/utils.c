/* utils.c generated by valac 0.20.1.19-a6516, the Vala compiler
...
static void kkc_key_event_utils_class_init (KkcKeyEventUtilsClass * klass) {
	...
	kkc_key_event_utils_keyname_to_keyval = (GeeMap*) _tmp1_;
	{
		...
		for (entry_it = 0; entry_it < G_N_ELEMENTS (KKC_keynames); entry_it = entry_it + 1) {
			...
			{
				GeeMap* _tmp2_;
				KkcKeynameEntry _tmp3_;
				guint _tmp4_;
				KkcKeynameEntry _tmp5_;
				const gchar* _tmp6_;
	...
	}
	{
		...
		for (entry_it = 0; entry_it < G_N_ELEMENTS (KKC_keynames); entry_it = entry_it + 1) {
			...
			{
				GeeMap* _tmp7_;
				KkcKeynameEntry _tmp8_;
				const gchar* _tmp9_;
				KkcKeynameEntry _tmp10_;
				guint _tmp11_;
