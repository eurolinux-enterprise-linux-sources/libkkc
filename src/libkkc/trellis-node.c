...
KkcBigramTrellisNode* kkc_bigram_trellis_node_construct (GType object_type, KkcUnigramTrellisNode* left_node, KkcUnigramTrellisNode* right_node, guint endpos) {
	...
	KkcUnigramTrellisNode* _tmp0_;
	KkcUnigramTrellisNode* _tmp1_;
	KkcUnigramTrellisNode* _tmp2_;
	...
	if (_tmp5_ < _tmp8_) {
		...
		const gchar* _tmp26_;
		gchar* _tmp27_;
		KkcUnigramTrellisNode* _tmp28_;
		KkcLanguageModelEntry _tmp29_;
...
static gchar* kkc_bigram_trellis_node_real_to_string (KkcTrellisNode* base) {
	...
	KkcLanguageModelEntry _tmp2_;
	const gchar* _tmp3_;
	KkcUnigramTrellisNode* _tmp4_;
	KkcLanguageModelEntry _tmp5_;
